...
locals {
  base_secrets = {
    ...
    external-dp-observability-client-id     = random_id.external_dp_observability_client_id.hex
    external-dp-observability-client-secret = random_password.external_dp_observability_client_secret.result
